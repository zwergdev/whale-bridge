export const DISABLED_PAIRS: { [key: number]: number[] } = {
  165: [125, 138, 116, 126, 167, 145, 153, 195, 151], // zk
  176: [
  ...
  111: [], // optimism
  125: [165, 176, 150, 116, 175, 167, 177, 181, 195, 202, 214, 153, 184, 151], // celo
  106: [], // avalanche
  175: [125, 150, 158, 116, 167, 145, 153, 181, 195, 214, 202, 138], // nova
  158: [176, 150, 175, 116, 167, 153, 195, 138, 181], // polygon-zk
  102: [], // bsc
  126: [165, 176, 167, 153, 195, 202, 138, 151], // moonbeam
  167: [165, 176, 125, 150, 175, 158, 116, 126, 195, 202, 138, 153, 181, 145], // moonriver
  145: [165, 176, 175, 116, 167, 153, 177, 195, 202], // gnosis
  202: [176, 125, 138, 150, 175, 116, 126, 167, 177, 145, 181, 153, 195, 151], // op-bnb
  112: [150, 195, 153], // fantom
  110: [], // arbitrum
  109: [], // polygon
  184: [125, 138, 116, 153], // base
  183: [153, 138, 176], // linea
  ...
  181: [176, 125, 138, 175, 116, 153, 202, 167, 158], // mantle
  153: [
  ...
  151: [165, 125, 116, 126, 153, 195, 202], // metis
}
